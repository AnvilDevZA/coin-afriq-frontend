...
const ToDelete = () => {
  return (
    <>
      <main>
        <section className="bg-[#E6BE8A] bg-[url('/full-bloom.png')] bg-blend-multiply  text-black px-6 py-8">
          <div className="max-w-6xl m-auto py-6 flex flex-col lg:flex-row  gap-6">
            <article>
              <h2 className="text-6xl text-[#4c3525] pb-4 font-serif">
                Why CoinAfriq
              </h2>
          ...
          <div className="max-w-6xl m-auto py-8 flex flex-col lg:flex-row gap-6">
            ...
            />
            <article>
              <h2 className="text-6xl text-[#4c3525] pb-4 font-serif text-right">
                How Secure is it?
              </h2>
        ...
        <section className="bg-[#e0ae6e] px-6 py-12">
          <article>
            ...
            />
            <h1 className="text-6xl text-[#4c3525] text-center py-6">
              Democracy at work
            </h1>
            <p className="text-2xl lg:text-3xl text-[#4c3525] text-center max-w-4xl m-auto">
